...
## Quick start — POSIX / macOS / Linux / WSL

```bash
# Alias (add to ~/.zshrc, ~/.bashrc, or ~/.bash_profile):
# alias n8n="$HOME/Documents/n8n_utilities_2026/n8n_extract_sync_2026_03_11/n8n"

../n8n_utilities_2026/n8n_extract_sync_2026_03_11/n8n help          # list all subcommands
../n8n_utilities_2026/n8n_extract_sync_2026_03_11/n8n backup --help # per-command flag reference
```

> The `n8n` POSIX wrapper lives at `n8n_extract_sync_2026_03_11/n8n` (no extension). It mirrors `n8n.ps1` exactly — same subcommands, same defaults, same pass-through behaviour.
...
> **Note:** Playwright setup and npm scripts work on any platform with Node.js. Browser-deps install differs by OS (see WSL notes below).
...
1. Inspect the failed run: `./n8n executions --execution-id <id> --include-data`
